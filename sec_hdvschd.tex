...
The following result sates that the CHD and, moreover, the sparsity of any EPHS, can be \emph{arbitrarily worse} than the HD.
We sketch the proof in \cref{fig:big_chd}.
