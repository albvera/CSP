...
If either $Q[s,v]$ or $Q[u,t]$ \SA{The directed edge is $(u,v)$, but the discussion here talks about $(s,v)$ and $(u,t)$. There is a mismatch in the notation. This carries over in the next paragraph. } is a shortest path or $\ell_{uv}\geq r$, then $Q$ is witnessed. Thus, we henceforth assume that all of the above conditions fail.
