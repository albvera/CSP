...
If the bounded growth is satisfied, we can obtain HL, in polynomial time, for the CSP to answer queries in average time $\Or(b\alpha h\log D)$ and with total storage $\Or(nB\cdot B\alpha h\log D)$.
\end{theorem}
