...
% that jointly encodes edge costs and lengths (\cref{theo:HLeff}). 
...
%To this end, 
We show how to adapt our ideas to develop practical data-structures for CSP queries based on {\em hub labels}~\cite{cohen_definition_hl}. 
