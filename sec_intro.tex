...
A related class of problems to CSP is that of SP under label constraints~\citep{language_csp}, where the aim is to find shortest paths that avoid certain labels (e.g. toll roads, ferries, etc.). 
