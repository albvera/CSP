...
We note that \citep{vc_shortest} also introduces a notion of average HD, but they use a more restrictive notion.
...
Finally, we remark that this weaker notion of average HD allows us to get stronger results (because it is easier to satisfy and verify), hence we believe it can be useful in other problems too.
}
