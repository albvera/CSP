...
%\begin{remark}
One criticism of the network in \cref{fig:big_chd} is that it has a maximum degree of $n$.
However, in \cite{TechReport}, we show via a more involved example that the result holds even for bounded degree graphs.
