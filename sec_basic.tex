...
We denote the shortest $(s,t)$-path (if it exists) \SA{Do any of the results require the graph to be strongly connected?} \anote{No. Should we mention that?} as $P(s,t)$, and denote the set of all shortest paths in $G$ as $\PS$.
