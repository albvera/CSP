...
To perform a query for $s,t,b$, we look only for nodes $\pp{u,x}$ with $x\leq b$ in the backward hub of $\pp{t,-1}$ \anote{this requires a data structure to know the level of each node, but I guess it's clear from the context}.
