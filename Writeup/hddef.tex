...
\end{proposition}
This follows directly from Theorem 4.2 in \cite{highway2013}, which showed it for the shortest-path system. Moreover, as we discuss in Section \todo{(?)}, if $G$ has HD$\leq h$, then this permits the construction of a $(h\log h,r)$-LSHS in polynomial time.
