We give a generalization of the notion of \emph{highway dimension}, introduced by \citep{highway2013,highway2010} to parametrize shortest-path computations in undirected graphs. 
...
Hitting sets are useful for compressing path systems, i.e., to bound the size of the data structure. 
