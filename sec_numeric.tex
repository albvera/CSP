...
Broadly speaking, instead of the augmented graph we use a \emph{pruned} version $\Gp^B$, which is a minimal representation.
Next, we use approximation algorithms based un clustering to obtain shortest path covers and create the hub labels.
The details of our practical algorithms can be found in our full version.

%\paragraph{Practical CSP Algorithms:}\label{ssec:practical}
