...
&\quad vu\in P, b=c(P[v,t]), x=c(P[u,t]) }.
\end{align*}
...
%We can compute the cover by rocessing one shortest path tree at a time, this translates to $\Omega(n^3\log n)$ running time, but $\Or(n)$ memory.
...
\centering
\includegraphics[clip, trim=0.2cm 0.3cm 0.4cm 0.2cm,scale=0.29]{TexImg/SF_query_dij_B25.pdf}
(a)
\end{minipage}%
\begin{minipage}[t]{.24\textwidth}
\centering
\includegraphics[clip, trim=1.3cm 0.3cm 0.2cm 0.2cm,scale=0.28]{TexImg/SF_query_hl_B25.pdf}
(b)
\end{minipage}%
\begin{minipage}[t]{.24\textwidth}
\centering
\includegraphics[clip, trim = 1.3cm 0.3cm 0cm 0cm,scale=0.28]{TexImg/SF_bwd_hub_size.pdf}
(c)
\end{minipage}%
\begin{minipage}[t]{.24\textwidth}
\centering
...
\centering
\includegraphics[clip, trim=4.5cm 4.8cm 4.7cm 3cm,height=5.5cm]{TexImg/SF_hub_sizes.pdf}
\includegraphics[clip, trim=15.8cm 0cm 0.4cm 1cm,height=5cm]{TexImg/SF_hub_sizes.pdf}
\end{minipage}%
\begin{minipage}[t]{.5\textwidth}
\centering
\includegraphics[clip, trim=3.7cm 2.9cm 4.2cm 3cm,height=5.5cm]{TexImg/sig_colapse.pdf}
\end{minipage}
