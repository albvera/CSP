Our theoretical algorithms need to be modified for applications.
...
We stress that this is just an easy way to get a ranking; more sophisticated heuristics that decide the next node to contract on-line usually work well in practice \cite{goldberg_survey,rice_csp}.
