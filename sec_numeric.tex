...
\]
\SA{Shouldn't $\bar P$ be $P$?} The following result shows how the HD of this system relates to that of $\PE$.
...
\SA{Tried to align the figures a bit with the reference to the figure.}
...
\SA{The numerics section is pretty short, but I guess this is okay for an OR submission.}
